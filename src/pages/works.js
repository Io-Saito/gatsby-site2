...
var WorkData=[
  ...
  {title:"電子書籍検索LineBot",date:"2021-3-10",img:"/static/images/cards/LIbbot.png",tools:"GAS,Python,Beautifulsoup",href:"/",paragraphs:["学術機関認証で読むことができる電子書籍を検索できるLINEBotです。","BeautifulSoupでスクレイピングしたデータをSpreadsheetに格納し,ユーザーのメッセージを受け付けて検索結果を返します。","サーバーはGASで立てました。"],key:1}
